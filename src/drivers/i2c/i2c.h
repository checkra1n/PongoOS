...
extern struct i2c_cmd* i2c_cmd_create(uint16_t txno);
extern void i2c_cmd_destroy(struct i2c_cmd* cmd);
extern void i2c_cmd_set_write_tx(struct i2c_cmd* cmd, uint16_t index, uint16_t address, const void* base, uint16_t size);
